...
public class WebViewerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //HTML 직접 생성
        //String msg = "<html><body>" + mEditText.getText().toString() + "</body></html>";
        //"<html><body>Hellow Android World!!!</body></html>";
        //baseURL, data, mimeType(문서타입), encoding, historyUrl
        //mWebView.loadDataWithBaseURL(null, msg, "text/html", "UTF-8", null);

        mWebView.loadDataWithBaseURL("file:///android_asset/test.html",
                "<meta http-equiv=’Content-Type’ content=’text/html; charset=utf-8′/><html><body> <img src='ic_launcher.png'/> Hello, 마이크!</body></html>",
                "text/html",
                "utf-8",
                "file:///android_asset/");
...
//        final String tag = "<a href = "http://localhost/"> Hello World - 1 </a>";
//        final String mimeType = “text/html”;
//        mWebView.loadData(tag, mimeType, encording);
